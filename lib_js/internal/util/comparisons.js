...
const { compare } = require('native')
const { isArrayBufferView, isDate, isMap, isRegExp, isSet } = require('internal/util/types');
...
/* We are using DukTape... It will be faster to be using C always
  if (len < max) {
