...
module.exports = {
     ...
     * The returned object holds strings indicating the error for the settings which could not be set, for example: {code: {auto_start: 'INVALID'}} if a Number is tried to be set instead of a Boolean.
