...
var Sender = /** @class */ (function () {
     ...
     * @public
     */
    Sender.frame = function (data, options) {
     ...
     * @private
     */
    Sender.prototype.doClose = function (data, mask, cb) {
     ...
     * @public
     */
    Sender.prototype.ping = function (data, mask, cb) {
        var readOnly = true;
     ...
     * @private
     */
    Sender.prototype.doPing = function (data, mask, readOnly, cb) {
        this.sendFrame(Sender.frame(data, {
            fin: true,
            rsv1: false,
            opcode: 0x09,
     ...
     * @public
     */
    Sender.prototype.pong = function (data, mask, cb) {
        var readOnly = true;
        if (!Buffer.isBuffer(data)) {
            if (data instanceof ArrayBuffer) {
                data = Buffer.from(data);
     ...
     * @private
     */
    Sender.prototype.doPong = function (data, mask, readOnly, cb) {
        this.sendFrame(Sender.frame(data, {
            fin: true,
            rsv1: false,
            opcode: 0x0a,
     ...
     * @private
     */
    Sender.prototype.dispatch = function (data, compress, options, cb) {
        var _this = this;
        if (!compress) {
     ...
     * @private
     */
    Sender.prototype.dequeue = function () {
     ...
     * @private
     */
    Sender.prototype.enqueue = function (params) {
        this._bufferedBytes += params[1].length;
